            ...
            <View style={styles.cardHome}>
                <View style={styles.iconsHome}>
                    <View style={styles.iconInfo}>
                        <TouchableOpacity>
                            <FontAwesome6 name="hourglass-start" size={24} color="green"  style={styles.icon}/>
                            <Text style={styles.textHome}>Not Started</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={styles.iconInfo}>
                        <TouchableOpacity>
                            <FontAwesome6 name="bars-progress" size={30} color="green" style={styles.icon}/>
                            <Text style={styles.textHome}>Ongoing</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={styles.iconInfo}>
                        <TouchableOpacity>
                            <FontAwesome6 name="handshake" size={30} color="green" style={styles.icon}/>
